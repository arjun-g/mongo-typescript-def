...
/// <reference path="node_modules/@types/bson/index.d.ts" />
...
export class Db extends EventEmitter {
    ...
    collection<TSchema>(name: string, callback: MongoCallback<Collection<TSchema>>): Collection<TSchema>;
    collection<TSchema>(name: string, options: DbCollectionOptions, callback: MongoCallback<Collection<TSchema>>): Collection<TSchema>;
    ...
    createCollection<TSchema>(name: string, options?: CollectionCreateOptions): Promise<Collection<TSchema>>;
    createCollection<TSchema>(name: string, options: CollectionCreateOptions, callback: MongoCallback<Collection<TSchema>>): void;
    ...
    renameCollection<TSchema>(fromCollection: string, toCollection: string, callback: MongoCallback<Collection<TSchema>>): void;
    renameCollection<TSchema>(fromCollection: string, toCollection: string, options?: { dropTarget?: boolean }): Promise<Collection<TSchema>>;
    renameCollection<TSchema>(fromCollection: string, toCollection: string, options: { dropTarget?: boolean }, callback: MongoCallback<Collection<TSchema>>): void;
...
export interface Collection<TSchema> {
    ...
    aggregate<T>(pipeline: Object[], options?: CollectionAggregationOptions, callback?: MongoCallback<T[]>): AggregationCursor<T>;
    ...
    /** @deprecated */
    find<T>(query: Object, fields?: Object, skip?: number, limit?: number, timeout?: number): Cursor<T>;
    //http://mongodb.github.io/node-mongodb-native/2.1/api/Collection.html#findOne
    findOne<T>(filter: Object, callback: MongoCallback<T>): void;
    findOne<T>(filter: Object, options?: FindOneOptions): Promise<T>;
    findOne<T>(filter: Object, options: FindOneOptions, callback: MongoCallback<T>): void;
